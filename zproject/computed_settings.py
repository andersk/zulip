...
CACHES = {
    "default": {
        ...
        "OPTIONS": {"tcp_nodelay": True, "retry_timeout": 1},
    },
    "database": {
        ...
        "TIMEOUT": None,
        "OPTIONS": {"MAX_ENTRIES": 100000000, "CULL_FREQUENCY": 10},
    },
...
INTERNAL_BOTS = [
    ...
    {"var_name": "NAGIOS_RECEIVE_BOT", "email_template": "nagios-receive-bot@%s", "name": "Nagios Receive Bot"},
    {"var_name": "WELCOME_BOT", "email_template": "welcome-bot@%s", "name": "Welcome Bot"},
]
...
LOGGING: Dict[str, Any] = {
    ...
    "formatters": {"default": {"()": "zerver.lib.logging_util.ZulipFormatter"}},
    "filters": {
