...
urls = [
    ...
    path(
        ...
        serve,
        {"document_root": os.path.join(settings.DEPLOY_ROOT, "var/node-coverage/lcov-report"), "show_indexes": True},
    ),
    path(
        "casper/<path:path>",
        serve,
    ...
    path("docs/<path:path>", serve, {"document_root": os.path.join(settings.DEPLOY_ROOT, "docs/_build/html")}),
