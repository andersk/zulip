...
export function persist_mute(stream_id, topic_name) {
    const data = {
        stream_id,
        topic: topic_name,
        op: "add",
...
export function persist_unmute(stream_id, topic_name) {
    const data = {
        stream_id,
        topic: topic_name,
        op: "remove",
...
export function handle_updates(muted_topics) {
...
export function mute(stream_id, topic) {
...
export function unmute(stream_id, topic) {
    ...
    unread_ui.update_unread_counts();
    rerender();
    persist_unmute(stream_id, topic);
    feedback_widget.dismiss();
    recent_topics.update_topic_is_muted(stream_id, topic);
}

export function toggle_mute(message) {
