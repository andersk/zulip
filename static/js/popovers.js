...
export const focus_first_popover_item = (items) => {
    if (!items) {
        return;
    }
...
export const popover_items_handle_keyboard = (key, items) => {
    if (!items) {
        return;
    }
...
export const user_sidebar_popped = () => current_user_sidebar_popover !== undefined;
