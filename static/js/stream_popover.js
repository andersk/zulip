...
export const topic_sidebar_menu_handle_keyboard = (key) => {
    const items = get_popover_menu_items(current_topic_sidebar_elem);
    popovers.popover_items_handle_keyboard(key, items);
};

export const all_messages_sidebar_menu_handle_keyboard = (key) => {
    const items = get_popover_menu_items(all_messages_sidebar_elem);
    popovers.popover_items_handle_keyboard(key, items);
};

export const starred_messages_sidebar_menu_handle_keyboard = (key) => {
