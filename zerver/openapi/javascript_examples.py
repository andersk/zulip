...
def test_js_bindings(client: Client) -> None:
    ...
    output = subprocess.check_output(args=["node", "zerver/openapi/javascript_examples.js"], universal_newlines=True)
    ...
    for response_data in endpoint_responses:
        ...
        validate_against_openapi_schema(
            response_data["result"], response_data["endpoint"], response_data["method"], response_data["status_code"],
        )
