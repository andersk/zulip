...
def update_message_backend(
    ...
    propagate_mode: Optional[str] = REQ(default="change_one", str_validator=check_string_in(PROPAGATE_MODE_VALUES)),
    ...
    if content is None and message.sender != user_profile and not user_profile.is_realm_admin and not is_no_topic_msg:
    ...
    if content is not None:
        ...
        mention_data = MentionData(realm_id=user_profile.realm.id, content=content)
