...
def send_webhook_fixture_message(
    ...
    return client.post(url, body, content_type=content_type, HTTP_HOST=http_host, **standardized_headers)
...
def check_send_webhook_fixture_message(
    ...
    if response.status_code == 200:
        responses = [{"status_code": response.status_code, "message": response.content}]
