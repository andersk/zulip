...
def update_realm(
    ...
    bot_creation_policy: Optional[int] = REQ(validator=check_int_in(Realm.BOT_CREATION_POLICY_TYPES), default=None),
    ...
    if signup_notifications_stream_id is not None:
        if realm.signup_notifications_stream is None or (
            ...
            do_set_realm_signup_notifications_stream(
                realm, new_signup_notifications_stream, signup_notifications_stream_id,
            )
