...
class DialogflowHookTests(WebhookTestCase):
    ...
    def test_dialogflow_default(self) -> None:
        ...
        self.send_and_test_private_message("default", expected_message, content_type="application/json")
    ...
    def test_dialogflow_alternate_result(self) -> None:
        ...
        self.send_and_test_private_message("alternate_result", expected_message, content_type="application/json")
    ...
    def test_dialogflow_exception(self) -> None:
        ...
        self.send_and_test_private_message("exception", expected_message, content_type="application/json")

    def get_body(self, fixture_name: str) -> str:
        return self.webhook_fixture_data("dialogflow", fixture_name, file_type="json")
