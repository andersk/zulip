...
class Bitbucket2HookTests(WebhookTestCase):
    ...
    EXPECTED_TOPIC_PR_EVENTS = "Repository name / PR #1 new commit"
    EXPECTED_TOPIC_ISSUE_EVENTS = "Repository name / Issue #1 Bug"
    ...
    def test_bitbucket2_on_push_commits_above_limit_event(self) -> None:
        ...
        self.send_and_test_stream_message(
            "push_commits_above_limit", self.EXPECTED_TOPIC_BRANCH_EVENTS, expected_message,
        )
    ...
    @patch("zerver.webhooks.bitbucket2.view.check_send_webhook_message")
    def test_bitbucket2_on_push_without_changes_ignore(self, check_send_webhook_message_mock: MagicMock) -> None:
