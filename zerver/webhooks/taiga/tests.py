...
class TaigaHookTests(WebhookTestCase):
    ...
    def test_taiga_issue_changed_subject(self) -> None:
        message = (
            "[TomaszKolek](https://tree.taiga.io/profile/kolaszek) renamed issue New issue to **New issueNewSubject**."
        )
    ...
    def test_taiga_epic_changed_description(self) -> None:
        message = (
            "[Eeshan Garg](https://tree.taiga.io/profile/eeshangarg) updated description of epic **Zulip is great!**."
        )
