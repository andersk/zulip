...
""".strip()
        ...
        self.send_and_test_stream_message(
            "missing_results_link", expected_topic, expected_message, content_type="application/x-www-form-urlencoded",
        )
...
""".strip()
        ...
        self.send_and_test_stream_message(
            "missing_search_name", expected_topic, expected_message, content_type="application/x-www-form-urlencoded",
        )
...
""".strip()
        ...
        self.send_and_test_stream_message(
            "missing_source", expected_topic, expected_message, content_type="application/x-www-form-urlencoded",
        )
...
""".strip()
        ...
        self.send_and_test_stream_message(
            "missing_raw", expected_topic, expected_message, content_type="application/x-www-form-urlencoded",
        )
