...
class ClubhouseWebhookTest(WebhookTestCase):
    ...
    def test_epic_update_add_comment(self) -> None:
        ...
        self.send_and_test_stream_message(
            "epic_update_add_comment", "New Cool Epic!", expected_message,
        )
    ...
    def test_story_update_add_description(self) -> None:
        ...
        self.send_and_test_stream_message(
            "story_update_add_description", "Story 2", expected_message,
        )
    ...
    def test_epic_update_change_name(self) -> None:
        ...
        self.send_and_test_stream_message(
            "epic_update_change_title", "New Cool Epic!", expected_message,
        )
    ...
    def test_story_epic_added(self) -> None:
        ...
        self.send_and_test_stream_message(
            "story_update_add_epic", "Add cool feature!", expected_message,
        )
    ...
    def test_story_update_add_github_branch(self) -> None:
        ...
        self.send_and_test_stream_message(
            "story_update_add_github_branch",
            "Testing pull requests with Story",
            expected_message,
        )
    ...
    @patch("zerver.lib.webhooks.common.check_send_webhook_message")
    def test_story_comment_updated_ignore(
        self, check_send_webhook_message_mock: MagicMock,
    ) -> None:
