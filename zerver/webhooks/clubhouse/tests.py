...
class ClubhouseWebhookTest(WebhookTestCase):
    ...
    def test_epic_update_add_comment(self) -> None:
        expected_message = (
            "New comment added to the epic **New Cool Epic!**:\n``` quote\nAdded a comment on this Epic!\n```"
        )
        self.send_and_test_stream_message("epic_update_add_comment", "New Cool Epic!", expected_message)
    ...
    def test_epic_update_remove_description(self) -> None:
        ...
        self.send_and_test_stream_message("epic_update_remove_description", "New Cool Epic!", expected_message)
    ...
    def test_epic_update_change_description(self) -> None:
        ...
        self.send_and_test_stream_message("epic_update_change_description", "New Cool Epic!", expected_message)
    ...
    def test_epic_update_change_name(self) -> None:
        ...
        self.send_and_test_stream_message("epic_update_change_title", "New Cool Epic!", expected_message)
    ...
    def test_story_update_add_owner(self) -> None:
        ...
        self.send_and_test_stream_message("story_update_add_owner", "A new story by Shakespeare!", expected_message)
    ...
    def test_story_epic_added(self) -> None:
        ...
        self.send_and_test_stream_message("story_update_add_epic", "Add cool feature!", expected_message)
    ...
    def test_story_file_attachment_added(self) -> None:
        ...
        self.send_and_test_stream_message("story_update_add_attachment", "Add cool feature!", expected_message)
    ...
    def test_story_label_added(self) -> None:
        expected_message = (
            "The label **mockup** was added to the story [An epic story!](https://app.clubhouse.io/zulip/story/23)."
        )
    ...
    def test_story_update_project(self) -> None:
        ...
        self.send_and_test_stream_message("story_update_change_project", "Add cool feature!", expected_message)
    ...
    def test_story_update_add_github_pull_request(self) -> None:
        ...
        self.send_and_test_stream_message(
            "story_update_add_github_pull_request", "Testing pull requests with Story", expected_message,
        )
