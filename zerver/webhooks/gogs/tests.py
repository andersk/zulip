...
* Webhook Test ([d8fce16](http://localhost:3000/john/try-git/commit/d8fce16c72a2ff56a5afc8a08645a6ce45491794))"""
    ...
    def test_pull_request_opened(self) -> None:
        ...
        expected_message = (
            """john opened [PR #1](http://localhost:3000/john/try-git/pulls/1) from `feature` to `master`."""
        )
    ...
    def test_pull_request_closed(self) -> None:
        expected_topic = "try-git / PR #1 Title Text for Pull Request"
        expected_message = (
            """john closed [PR #1](http://localhost:3000/john/try-git/pulls/1) from `feature` to `master`."""
        )
    ...
    def test_pull_request_merged(self) -> None:
        ...
        expected_message = (
            """john merged [PR #2](http://localhost:3000/john/try-git/pulls/2) from `feature` to `master`."""
        )
    ...
    def test_pull_request_reopened(self) -> None:
        ...
        expected_message = (
            """kostekIV reopened [PR #2](https://try.gogs.io/kostekIV/test/pulls/2) from `c` to `master`."""
        )
    ...
    def test_pull_request_edited(self) -> None:
        ...
        expected_message = (
            """kostekIV edited [PR #2](https://try.gogs.io/kostekIV/test/pulls/2) from `c` to `master`."""
        )
    ...
    def test_pull_request_assigned(self) -> None:
        expected_topic = "test / PR #1349 Test"
        expected_message = (
            """kostekIV assigned [PR #2](https://try.gogs.io/kostekIV/test/pulls/2) from `c` to `master`."""
        )
    ...
    def test_issues_opened(self) -> None:
        ...
        expected_message = (
            """kostekIV opened [Issue #3](https://try.gogs.io/kostekIV/test/issues/3):\n\n~~~ quote\nTest\n~~~"""
        )
    ...
    def test_push_filtered_by_branches_ignore(self, check_send_webhook_message_mock: MagicMock) -> None:
        ...
        result = self.client_post(self.url, payload, HTTP_X_GOGS_EVENT="push", content_type="application/json")
