...
class Bitbucket3HookTests(WebhookTestCase):
    ...
    def test_commit_comment_edited(self) -> None:
        ...
        self.send_and_test_stream_message("commit_comment_edited", self.EXPECTED_TOPIC, expected_message)
    ...
    def test_commit_comment_deleted(self) -> None:
        ...
        self.send_and_test_stream_message("commit_comment_deleted", self.EXPECTED_TOPIC, expected_message)
    ...
    def test_pr_opened_without_description(self) -> None:
        ...
        self.send_and_test_stream_message("pull_request_opened_without_description", expected_topic, expected_message)
    ...
    def test_pr_modified(self) -> None:
        ...
        self.send_and_test_stream_message("pull_request_modified", expected_topic, expected_message)
    ...
    def test_pr_declined(self) -> None:
        ...
        self.send_and_test_stream_message("pull_request_declined", expected_topic, expected_message)
    ...
    def test_pr_approved(self) -> None:
        ...
        self.send_and_test_stream_message("pull_request_approved", expected_topic, expected_message)
    ...
    def test_pull_request_comment_added(self) -> None:
        ...
        expected_topic = "sandbox / PR #6 sample_file: Add sample_file.txt."
        self.send_and_test_stream_message("pull_request_comment_added", expected_topic, expected_message)
    ...
    def test_pull_request_comment_edited(self) -> None:
        ...
        expected_topic = "sandbox / PR #6 sample_file: Add sample_file.txt."
        self.send_and_test_stream_message("pull_request_comment_edited", expected_topic, expected_message)
