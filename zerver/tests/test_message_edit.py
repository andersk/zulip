...
class EditMessageTest(ZulipTestCase):
    ...
    def test_edit_message_history_disabled(self) -> None:
        ...
        json_messages = orjson.loads(messages_result.content.decode("utf-8"))
    ...
    def test_edit_message_history(self) -> None:
        ...
        json_response_1 = orjson.loads(message_edit_history_1.content.decode("utf-8"))
        ...
        json_response_2 = orjson.loads(message_edit_history_2.content.decode("utf-8"))
