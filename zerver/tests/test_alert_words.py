...
class AlertWordTests(ZulipTestCase):
    ...
    def test_realm_words(self) -> None:
        ...
        self.assertEqual(
            set(realm_words[user1.id]), set(self.interesting_alert_word_list),
        )
    ...
    def test_update_alert_words(self) -> None:
        ...
        result = self.client_patch(
            ...
            {"message_id": original_message.id, "content": "new ALERT for you"},
        )
        self.assert_json_success(result)
        ...
        result = self.client_patch(
            "/json/messages/" + str(original_message.id),
            {"message_id": original_message.id, "content": "sorry false alarm"},
        )
        self.assert_json_success(result)
