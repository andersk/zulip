...
class PublicURLTest(ZulipTestCase):
    ...
    def test_public_urls(self) -> None:
        ...
        post_urls = {
            ...
            400: ["/api/v1/external/github", "/api/v1/fetch_api_key"],
        }
        patch_urls = {
            401: ["/json/settings"],
        }
...
class URLResolutionTest(ZulipTestCase):
    def get_callback_string(
        self, pattern: django.urls.resolvers.URLPattern,
    ) -> Optional[str]:
    ...
    def check_function_exists(self, module_name: str, view: str) -> None:
        ...
        self.assertTrue(
            hasattr(module, view), f"View {module_name}.{view} does not exist",
        )
