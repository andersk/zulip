...
class QueryUtilTest(ZulipTestCase):
    ...
    def test_query_chunker(self) -> None:
        ...
        list(chunker)  # exhaust the iterator
        self.assertEqual(
            len(all_msg_ids), len(Message.objects.exclude(sender_id=cordelia.id)),
        )
...
class ImportExportTest(ZulipTestCase):
    ...
    def test_zulip_realm(self) -> None:
        ...
        self.assertEqual(
            exported_streams, {"Denmark", "Rome", "Scotland", "Venice", "Verona"},
        )
    ...
    def test_export_realm_with_member_consent(self) -> None:
        ...
        stream_b_message_id = self.send_stream_message(self.example_user("prospero"), "Private B", "Hello Stream B")
