...
class WidgetContentTestCase(ZulipTestCase):
    ...
    def test_explicit_widget_content(self) -> None:
        ...
        zform_data = dict(type="choices", heading="Options:", choices=[])

        widget_content = dict(widget_type="zform", extra_data=zform_data)
        ...
        expected_submessage_content = dict(widget_type="zform", extra_data=zform_data)
    ...
    def test_tictactoe(self) -> None:
        ...
        expected_submessage_content = dict(widget_type="tictactoe", extra_data=None)
    ...
    def test_poll_command_extra_data(self) -> None:
        ...
        expected_submessage_content = dict(
            widget_type="poll",
            extra_data=dict(options=["Red", "Green", "Blue", "Yellow"], question="What is your favorite color?"),
        )
