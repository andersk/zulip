...
class SlackImporter(ZulipTestCase):
    ...
    def test_channels_to_zerver_stream(self) -> None:
        ...
        self.assertEqual(
            self.get_set(zerver_recipient, "type_id"), {0, 1, 2, 3, 5, 7, 8},
        )
    ...
    def test_slack_import_to_existing_database(
        ...
        output_dir = os.path.join(
            settings.DEPLOY_ROOT, "var", "test-slack-importer-data",
        )
        token = "valid-token"
    ...
    def test_message_files(self) -> None:
        ...
        files = [
            ...
            dict(url_private="example.com/banana.zip", title="banana"),
        ]
