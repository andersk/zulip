...
class BulkCreateUserTest(ZulipTestCase):
    def test_create_users(self) -> None:
        ...
        self.assertEqual(
            fred.email, f"user{fred.id}@zulip.testserver",
        )
...
class UserProfileTest(ZulipTestCase):
    ...
    def test_bulk_get_users(self) -> None:
        ...
        result = bulk_get_users([hamlet.email, cordelia.email], get_realm("zulip"))
...
class RecipientInfoTest(ZulipTestCase):
    ...
    def test_get_recipient_info_invalid_recipient_type(self) -> None:
        ...
        stream_topic = StreamTopicTarget(stream_id=stream.id, topic_name="test topic")
...
class BulkUsersTest(ZulipTestCase):
    def test_client_gravatar_option(self) -> None:
        ...
        self.assertEqual(
            get_hamlet_avatar(client_gravatar=True), None,
        )
        ...
        """
        self.assertIn(
            "gravatar.com", get_hamlet_avatar(client_gravatar=False),
        )
