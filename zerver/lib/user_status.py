...
def update_user_status(user_profile_id: int, status: Optional[int], status_text: Optional[str], client_id: int) -> None:
    ...
    UserStatus.objects.update_or_create(
        user_profile_id=user_profile_id, defaults=defaults,
    )
