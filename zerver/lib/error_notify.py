...
def zulip_browser_error(report: Dict[str, Any]) -> None:
    ...
    internal_send_stream_message(
        realm, error_bot, errors_stream, format_email_subject(email_subject), body,
    )
...
{request_repr}"""
    ...
    internal_send_stream_message(
        realm, error_bot, errors_stream, format_email_subject(email_subject), message,
    )
...
def do_report_error(
    deployment_name: str, type: str, report: Dict[str, Any],
) -> HttpResponse:
