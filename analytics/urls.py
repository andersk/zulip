...
i18n_urlpatterns = [
    ...
    path("activity", analytics.views.get_activity, name="analytics.views.get_activity"),
    path("activity/support", analytics.views.support, name="analytics.views.support"),
    path(
        "realm_activity/<str:realm_str>/",
        analytics.views.get_realm_activity,
        name="analytics.views.get_realm_activity",
    ),
    path(
        "user_activity/<str:email>/", analytics.views.get_user_activity, name="analytics.views.get_user_activity",
    ),
    path("stats/realm/<str:realm_str>/", analytics.views.stats_for_realm, name="analytics.views.stats_for_realm"),
    path(
        "stats/installation",
        analytics.views.stats_for_installation,
    ...
    path("stats", analytics.views.stats, name="analytics.views.stats"),
]
