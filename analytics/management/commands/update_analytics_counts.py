...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--stat", "-s", type=str, help="CountStat to process. If omitted, all stats are processed.")
        parser.add_argument("--verbose", action="store_true", help="Print timing information to stdout.", default=False)
